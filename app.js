...
function forceRefreshCount(){ updateRecordCount(); } record${all.length===1?"":"s"} stored`;
...
window.addEventListener("load", async ()=>{
  ...
  const refreshBtn=document.querySelector("#btnRefresh"); if(refreshBtn){refreshBtn.addEventListener("click",forceRefreshCount);} 
